    ...
    <div class="layout-wrapper layout-content-navbar">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="mb-0 row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <input class="form-control" type="date" value="{{ $datenewdata }}"
                        ...
                        <div class="row mb-4" id="sortable-cards">
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        class="dropdown-item d-flex align-items-center">Last 7 Days</a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        class="dropdown-item d-flex align-items-center">Last Month</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-12 mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="doughnutChartKehadiran2" class="chartjs mb-4"
                            ...
                            <div class="col-lg-4 col-12 mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <canvas id="doughnutChartAttendanceGender" class="chartjs mb-4"
                                            data-height="350"></canvas>
                                        <ul class="doughnut-legend d-flex justify-content-around ps-0 mb-2 pt-1">
                                            <li class="ct-series-0 d-flex flex-column">
                                                <h5 class="mb-0 fw-bold">Pria</h5>
        ...
        <script>
            ...
            if (typeof analyticsBarChartElDirectorat !== undefined && analyticsBarChartElDirectorat !== null) {
                const analyticsBarChartDirectorat = new ApexCharts(analyticsBarChartElDirectorat,
                    analyticsBarChartConfigDirectorat);
